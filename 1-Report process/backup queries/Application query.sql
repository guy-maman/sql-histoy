...
<QueryList>
    ...
    <queries>
        ...
        <QueryEntity>
            ...
            <query>
   		    <![CDATA[
                    select toYYYYMMDD(recordOpeningTime) date,
                    sum(listOfTrafficIn)/1024/1024 download,
                    sum(listOfTrafficOut)/1024/1024 upload,
                    (sum(listOfTrafficIn) + sum(listOfTrafficOut))/1024/1024 total
                    from data_ericsson
