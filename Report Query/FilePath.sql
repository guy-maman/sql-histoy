...
--         filepath like '%VTF10875_20221215001435%'
...
-- MSC
--MSC1
select substring(filepath,19,16) FileName, max(eventTimeStamp) date,substring(filepath,30,5) seq
from mediation.zte
      where toYear(eventTimeStamp) = (:year)
        and toMonth(eventTimeStamp) = (:month)
--     and filepath like '%MSC2022053149987.dat%'
