-- create table Orange_Daily (Orange DateTime, On_Net int,International_Incoming int,International_Outgoing int,MTN_To_Orange int,Orange_To_MTN int) ENGINE = Memory;
-- drop table Orange_Daily
...
from (
      select callReference,
             ...
             case
                 when (incomingTKGPName not in
                       ('Comium', 'LoneStar', 'BICS-4194', 'OCI_ASSB', 'OCI_KM4', 'Orange-12490', 'BICS-4193',
